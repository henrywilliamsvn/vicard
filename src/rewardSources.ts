...
export const REWARD_SOURCES: RewardSource[] = [
  ...
  },
  {
    ...
    layer: "voucher",
    categories: ["online"],
    note: "Grab in-app vouchers and live-stream deals, then check out — strong for trending and low-price online buys.",
    url: "https://www.tiktok.com/",
    setup: "Open TikTok Shop, collect vouchers in the voucher centre, and link your best card at checkout.",
  ...
  },
  {
    ...
    layer: "voucher",
    categories: ["online"],
    note: "Genuine-goods marketplace with fast delivery — collect Astra points + platform vouchers, then pay with your best card.",
    url: "https://tiki.vn/",
    setup: "Open Tiki, collect vouchers from the voucher centre, and link your best card at checkout.",
    setupUrl: "https://tiki.vn/",
  },
  {
    name: "MoMo",
    layer: "wallet",
